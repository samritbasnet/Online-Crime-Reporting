  ...
  background-size: cover;">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>10:00pm</td>
                                            <td>Officer Recard</td>
                                            <td><span class="badge badge-primary">Data</span></td>
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="smallmodalLabel">Add Reponse Information : </h5>
                     ...
                     <div class="card-body card-block">
                          <div class="form-group">
                             <select name="select" id="select" class="form-control">
                               <option value="0">Select Crime Description</option>
                ...
                <div class="form-group">
                        <label for="company" class=" form-control-label">Reponse Date : </label>
                    <input type="date"  placeholder="+63----------" class="form-control">
                </div>
                <div class="form-group">
                        <label for="company" class=" form-control-label">Reponse Time : </label>
                    <input type="time"  placeholder="Enter Email -@-" class="form-control">
                </div>
                ...
                <button type="button" class="btn btn-danger" data-dismiss="modal" style="margin-right: 66%">Cancel</button>
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            <form>
                            <div class="modal-header">
                                <h5 class="modal-title" id="smallmodalLabel">Update Response Information : </h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                          </div>
