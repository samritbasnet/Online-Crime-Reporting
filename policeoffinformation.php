        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Officer Recardo</td>
                                            <td>0925668955</td>
                                            <td>Katalbas Street, Pob 11</td>
                                            <td>ggggggg@gmail.com</td>
                                            <td>Recard11</td>
                                            <td>*********</td>
                                            <td><span class="badge badge-primary">User 1</span></td>
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                <h5 class="modal-title" id="smallmodalLabel">Add Police Information : </h5>
                   ...
                   <input type="text"  placeholder="Enter Officer Fullname" class="form-control">
                </div>
                <div class="form-group">
                        <label for="company" class=" form-control-label">Mobile Number : </label>
                    <input type="number"  placeholder="+63----------" class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text"  placeholder="Enter Officer Address" class="form-control">
                </div> 
                <div class="form-group">
                        <label for="company" class=" form-control-label">Username : </label>
                    <input type="text"  placeholder="Enter Officer Username" class="form-control">
                </div>  
                <div class="form-group">
                        <label for="company" class=" form-control-label">Password : </label>
                    <input type="password"  placeholder="Enter Officer Username" class="form-control">
                </div>  
            </div>
                </div>
                ...
                <button type="button" class="btn btn-danger" data-dismiss="modal" style="margin-right: 66%">Cancel</button>
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            <form>
                            <div class="modal-header">
                                <h5 class="modal-title" id="smallmodalLabel">Update Police Information : </h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                          </div>
