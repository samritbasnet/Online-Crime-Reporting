        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="policeoffinformation.php"> <i class="menu-icon fa fa-file"></i>Police Officer Information  </a>
                    </li>
                    <li >
                        <a href="responseinformation.php"> <i class="menu-icon fa fa-file"></i>Response Information </a>
                    </li>
                    <li >
                        <a href="residentinformation.php"> <i class="menu-icon fa fa-file"></i>Resident Information </a>
                    </li>
                    <li>
                    ...
                    <li >
                        <a href="crimecategory.php"> <i class="menu-icon fa fa-folder"></i>Crime Category Encoding </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>10:30pm</td>
                                            <td>Data</td>
                                            <td>Kelin Dre Kethh</td>
                                            <td>An illegal act for which someone can be punished</td>
                                            <td><span class="badge badge-primary">Offense</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td>Kelin Dre Kethh</td>
                                            <td>An illegal act for which someone can be punished</td>
                                            <td><span class="badge badge-danger">Guilty</span></td>
                                            <td><<button type="button" class="btn btn-sm btn-info" data-toggle="modal" data-target="#edit"><i class="fa fa-edit"></i></button> <button type="button" class="btn btn-sm btn-danger" ><i class="fa fa-trash"></i></button></td>
                                    </tbody>
                                        </tr>
                                            <tr style="background-color: #a5a5a5;">
                     ...
                     <div class="card-body card-block">
                          <div class="form-group">
                             <select name="select" id="select" class="form-control">
                               <option value="0">Select Category Description</option>
                    ...
                    <div class="form-group">
                        <label for="company" class=" form-control-label">Crime Description :</label>
                   <textarea name="textarea-input" id="textarea-input" rows="5" placeholder="Content..." class="form-control"></textarea>
                </div>
                <div class="form-group">
                        <label for="company" class=" form-control-label">Location : </label>
                    <input type="text" id="company" placeholder="Enter Location Here" class="form-control">
                </div>
                <div class="form-group">
                        <label for="company" class=" form-control-label">Status : </label>
                    <input type="text" id="company" placeholder="Enter Status" class="form-control">
                </div>
                <div class="form-group">
                        <label for="company" class=" form-control-label">Date Reported : </label>
                    <input type="text" id="company" placeholder="MM  /  DD /  YY" class="form-control">
                </div> 
                <div class="form-group">
                        <label for="company" class=" form-control-label">Time Reported : </label>
                    <input type="text" id="company" placeholder="00:00 --" class="form-control">
                </div>    
                <div class="form-group">
                ...
                <button type="button" class="btn btn-danger" data-dismiss="modal" style="margin-right: 66%">Cancel</button>
                    ...
                    <div class="modal-dialog modal-md" role="document">
                        <div class="modal-content">
                            <form>
                            <div class="modal-header">
                                <h5 class="modal-title" id="smallmodalLabel">Update Crime Information : </h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                          </div>
